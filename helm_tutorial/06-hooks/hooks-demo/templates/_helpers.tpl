...
helm.sh/chart: {{ include "hooks-demo.chart" . }}
...
*/}}
{{- define "hooks-demo.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "hooks-demo.fullname" .) .Values.serviceAccount.name }}
{{- else }}
